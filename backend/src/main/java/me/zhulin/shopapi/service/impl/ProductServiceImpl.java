...
public class ProductServiceImpl implements ProductService {
    ...
    public List<ProductInfo> searchProducts(String keyword) {
        ...
        return productInfoRepository.findByProductNameLike(searchPattern);
    }

    //-------

    @Override
    public Page<ProductInfo> searchP(Pageable pageable, String keyword) {
        String searchPattern = "%" + keyword + "%";
        return productInfoRepository.findProductInfoByProductNameLike(pageable, searchPattern);
    }
